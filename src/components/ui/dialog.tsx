...
/**
 * ⚠️ DIALOG POSITIONING - RÈGLE D'OR
 * 
 * NE JAMAIS redéfinir ces classes dans <DialogContent> :
 * - fixed, left-[...], top-[...]
 * - translate-x-[...], translate-y-[...]
 * - z-[...] (utiliser les variables CSS --z-modal)
 * 
 * Le centrage est géré automatiquement par ce composant.
 * 
 * ✅ Classes autorisées :
 * - Largeur : max-w-*, w-*
 * - Hauteur : max-h-*, h-*
