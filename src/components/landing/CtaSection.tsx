...
const CtaSection = () => {
  ...
  return (
    <section className="py-16 sm:py-20 md:py-32 bg-gradient-to-br from-white via-brand-50/20 to-white relative overflow-hidden">
      {/* Decorative elements */}
      ...
      <div className="container mx-auto px-4 sm:px-6 text-center relative z-10 max-w-4xl">
        ...
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-display font-extrabold mb-6 sm:mb-8 animate-slide-in-up">
          {i18n.language === 'en' ? (
            <>Ready for your <span className="font-signature text-4xl sm:text-5xl md:text-6xl gradient-text-animated block sm:inline">next adventure</span>?</>
          ) : (
            <>Prêt pour ta <span className="font-signature text-4xl sm:text-5xl md:text-6xl gradient-text-animated block sm:inline">prochaine aventure</span> ?</>
          )}
        </h2>
        <p className="text-lg sm:text-xl md:text-2xl text-muted-foreground mb-8 sm:mb-10 max-w-3xl mx-auto leading-relaxed animate-slide-in-up" style={{animationDelay: '0.1s'}}>
        ...
        <div className="animate-slide-in-up" style={{animationDelay: '0.2s'}}>
          <Button 
            ...
            size="lg" 
            className="magnetic-button bg-primary hover:bg-primary text-primary-foreground font-bold px-12 sm:px-16 py-6 sm:py-7 text-lg sm:text-xl transform transition-all duration-300 shadow-glow-strong animate-pulse-glow group w-full sm:w-auto max-w-md sm:max-w-none rounded-2xl"
          >
        ...
        <p className="mt-6 sm:mt-8 text-sm sm:text-base text-muted-foreground leading-relaxed px-2 animate-slide-in-up" style={{animationDelay: '0.3s'}}>
