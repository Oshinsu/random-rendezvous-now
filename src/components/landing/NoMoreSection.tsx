...
const NoMoreSection = () => {
  ...
  return <section className="py-16 sm:py-20 md:py-32 bg-gradient-to-br from-brand-500 via-brand-600 to-brand-700 text-primary-foreground relative overflow-hidden">
      {/* Decorative patterns */}
