...
-- Fix the automatic bar assignment trigger system
...
BEGIN
    ...
    IF current_count = 5 AND group_info.status = 'waiting' THEN
        ...
        -- Trigger automatic bar assignment IMMEDIATELY
...
-- Remove the old trigger_auto_bar_assignment function since we're handling it directly
